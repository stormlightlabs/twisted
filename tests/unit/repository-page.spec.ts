...
describe('RepositoryPage', () => {
	...
	test('renders identity, independent overview data, safe actions, and README content', async () => {
		...
		expect(fakeClient.getRepositoryLanguages).toHaveBeenCalledWith(repoDid, expect.any(Object))
		expect(fakeClient.getRepositoryTree).toHaveBeenCalledWith(repoDid, expect.any(Object))
		expect(fakeClient.repositoryArchiveUrl).toHaveBeenCalledWith(repoDid, 'tar.gz')
		expect(fakeClient.repositoryArchiveUrl).toHaveBeenCalledWith(repoDid, 'zip')
